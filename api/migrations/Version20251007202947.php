...
final class Version20251007202947 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE capture (id INT AUTO_INCREMENT NOT NULL, room_id INT NOT NULL, type_id INT NOT NULL, value NUMERIC(6, 2) NOT NULL, description VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_8BFEA6E554177093 (room_id), INDEX IDX_8BFEA6E5C54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
